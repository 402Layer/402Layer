...
**Base URL:** `https://studio.x402omega.cc`
...
```json
{
  "campaigns": [
    {
      ...
      "category": "tech",
      "subcategory": "defi",
      "page_url": "https://studio.x402omega.cc/fundraisers/my-campaign-a1b2c3d4",
      "api_url": "https://studio.x402omega.cc/api/campaigns/my-campaign-a1b2c3d4",
  ...
  "agent": {
    "description": "Omega Fundraisers — crowdfunding campaigns with x402 payments. First 100 supporters earn proportional fee-sharing on the launched token.",
    "protocol": "x402",
    "currency": "USDC",
    "list_url": "https://studio.x402omega.cc/api/campaigns",
    "detail_url_pattern": "https://studio.x402omega.cc/api/campaigns/{slug}",
    "campaign_page_pattern": "https://studio.x402omega.cc/fundraisers/{slug}",
...
```json
{
  ...
  "agent": {
    "payment_endpoint": "https://api.x402omega.cc/e/fund-my-campaign-a1b2c3d4",
    "accepts": ["solana"],
    "currency": "USDC",
    "protocol": "x402",
    "min_amount": 1,
    ...
    "campaign_url": "https://studio.x402omega.cc/fundraisers/my-campaign-a1b2c3d4",
    "campaign_api_url": "https://studio.x402omega.cc/api/campaigns/my-campaign-a1b2c3d4",
    "contribute_api": "https://studio.x402omega.cc/api/campaigns/my-campaign-a1b2c3d4/contributions",
...
curl -i "https://api.x402omega.cc/e/fund-my-campaign-a1b2c3d4?action=purchase&amount=100.00"

# 2. Submit the receipt token to record the contribution
curl -X POST https://studio.x402omega.cc/api/campaigns/my-campaign-a1b2c3d4/contributions \
...
1. Verifies the receipt JWT signature against x402omega JWKS
...
For agentic creation, you can either use Omega MCP with a scoped dashboard PAT, or use the direct worker campaign-management surface with an owner-linked `X-API-Key`. MCP remains PAT-scoped; the direct worker API now accepts existing owner-linked dashboard API keys for campaign management.
...
```json
{
  ...
  "campaign": {
    ...
    "slug": "my-campaign-a1b2c3d4",
    "title": "My Campaign",
    "url": "https://studio.x402omega.cc/fundraisers/my-campaign-a1b2c3d4",
