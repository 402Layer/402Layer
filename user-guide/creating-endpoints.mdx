---
title: Creating Endpoints - Omega Studio Docs
description: How to create and configure paid API endpoints
---

# Creating Endpoints

Endpoints are the core of Omega Studio. They turn your APIs into paid services that accept crypto payments automatically.
...
> **Important:** When you create an endpoint, Omega Studio generates an **Origin Protection Key** (API Key). This key is used by the x402 Gateway to authenticate requests to your origin server.
>
...
Before showing the payment button, Omega Studio runs a health check against your origin URL to verify your service is reachable. If the check fails, the payment page shows **"Service Unavailable"** and disables the pay button — protecting customers from paying for a down service.
...
If your origin server has an OpenAPI or Swagger spec, Omega Studio will automatically detect it when you enter your origin URL. Detected routes are pre-populated in the form builder — you can edit or remove them.
...
curl https://api.x402omega.cc/api/public/endpoints/your-slug
