---
title: Getting Started - Omega Studio Docs
description: Quick start guide to Omega Studio - prerequisites and initial setup 
---

# Getting Started with Omega Studio

This guide will help you set up Omega Studio and create your first paid endpoint in under 10 minutes.
...
Your wallet is now linked to your Omega Studio account.
...
```bash
curl https://studio.x402omega.cc/api/public/endpoints/my-endpoint
```
