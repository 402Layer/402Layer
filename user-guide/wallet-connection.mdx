---
title: Wallet Connection - Omega Studio Docs
description: How to connect Base and Solana wallets
---

# Wallet Connection

Omega Studio uses crypto wallets for authentication and receiving payments. Connect wallets on both Base (EVM) and Solana networks.
