---
title: Components Library - Omega Studio Docs
description: Embeddable payment widgets for your website
---

# Components Library
 
Omega Studio offers ready-to-use payment components you can embed directly into your website. Each component creates x402 endpoints automatically and handles crypto payments seamlessly.
...
```html
<iframe
  src="https://studio.x402omega.cc/embed/abc123xy"
  width="100%"
  height="600"
  frameborder="0"
...
**Script Embed**
```html
<script src="https://studio.x402omega.cc/embed/abc123xy.js"></script>
