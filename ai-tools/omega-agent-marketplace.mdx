---
title: "Omega Agent on the Marketplace"
description: "How AI agents interact with the x402Studio marketplace via MCP"
---

# Omega Agent on the Marketplace

The Omega MCP server exposes **35 tools** that let any MCP-compatible AI client (Claude Desktop, Cursor, Windsurf, Claude Code, etc.) interact with the x402Studio marketplace. Browse listings, manage endpoints, process payments, and register agents — all through natural language.
...
| Method | Format | Scope |
|--------|--------|-------|
| **Personal Access Token (PAT)** | `omega_pat_{48hex}` | Owner-wide (all endpoints + products) |
