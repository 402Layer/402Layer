---
title: Marketplace API - Omega Studio
...
`GET https://api.x402omega.cc/api/marketplace`

<CodeGroup>
```bash cURL
curl "https://api.x402omega.cc/api/marketplace?type=agentic&chain=base"
```
...
response = requests.get(
    "https://api.x402omega.cc/api/marketplace",
...
const response = await fetch(
  "https://api.x402omega.cc/api/marketplace?type=agentic&chain=base"
);
  ...
  "listings": [
    {
      ...
      // Access URLs
      "x402Endpoint": "https://api.x402omega.cc/e/super-trader", // API Target
      "payUrl": "https://studio.x402omega.cc/pay/endpoint/super-trader",
