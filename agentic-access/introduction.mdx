---
title: "Agentic Access: Introduction - Omega Studio Docs"
description: How AI agents can discover and pay for x402-enabled APIs
---

# Agentic Access: Introduction

Omega Studio enables AI agents to discover, evaluate, and pay for API access automatically, without human intervention.
...
```bash
curl https://api.x402omega.cc/e/my-api \
