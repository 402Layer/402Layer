---
title: Omega Skill - Omega Studio Docs
description: Portable full-platform skill for skills.sh-compatible agents
---

# Omega Skill

The **omega** skill is the portable full-platform package for skills.sh-compatible agents.
...
- optional PAT-backed Omega MCP guidance
...
```bash
npx skills add https://github.com/gitsafeteam/omega-skill --skill omega
```
...
- **Optional MCP mode** — use Omega MCP with a dashboard PAT for owner-scoped control-plane actions
...
- **omega** = portable skills.sh package
