...
description: Register trustless on-chain AI agent identities via Omega Layer
---
...
All ERC-8004 endpoints are hosted at `api.x402omega.cc`
...
const challenge = await fetch('https://api.x402omega.cc/agent/auth/challenge', {
  method: 'POST',
