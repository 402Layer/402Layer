...
### Check Balance
```bash
curl "https://api.x402omega.cc/api/credits/balance?endpoint=<slug>" \
  -H "x-wallet-address: 0xYourWallet..."
```

### Consume Endpoint
```bash
curl "https://api.x402omega.cc/e/<slug>" \
  -H "x-wallet-address: 0xYourWallet..." \
...
```json
{
  ...
  "current_balance": 0,
  "purchase_url": "https://studio.x402omega.cc/pay/credits/<slug>",
...
```text
https://studio.x402omega.cc/pay/credits/<slug>
```
