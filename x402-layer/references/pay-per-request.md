...
python {baseDir}/scripts/awal_cli.py pay-url https://api.x402omega.cc/e/my-endpoint
```
...
python {baseDir}/scripts/ows_cli.py pay-url https://api.x402omega.cc/e/my-endpoint --wallet hackathon-wallet
```
...
```bash
python {baseDir}/scripts/pay_base.py https://api.x402omega.cc/e/my-endpoint --agentkit auto
```
...
```bash
curl https://api.x402omega.cc/e/my-endpoint
```
