...
Use this reference when the goal is not just "pay for an API", but "add Omega payments to a product, app, bot, or platform".
...
Examples:
- product page: `https://studio.x402omega.cc/pay/<slug>`
- endpoint request page: `https://studio.x402omega.cc/pay/request/<slug>`
- credits page: `https://studio.x402omega.cc/pay/credits/<slug>`
...
### Hosted pay page
```
https://studio.x402omega.cc/pay/credits/my-api?order_id=abc-123&plan=pro
```

### Direct endpoint
```
https://api.x402omega.cc/e/my-api?factory_payment_id=f1ee6b40-...
```
...
SDK docs:
- `https://studio.x402omega.cc/docs/developer/sdk-receipts`
