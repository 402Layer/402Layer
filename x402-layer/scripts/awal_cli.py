...
def _split_url(url: str) -> Tuple[str, str]:
    ...
    if not parsed.scheme or not parsed.netloc:
        raise ValueError("URL must include scheme and host (e.g. https://api.x402omega.cc/e/gifu)")
...
Examples:
  ...
  python awal_cli.py pay-url https://api.x402omega.cc/e/gifu
  python awal_cli.py discover-url https://api.x402omega.cc/e/gifu?action=purchase
