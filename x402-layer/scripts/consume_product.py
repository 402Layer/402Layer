#!/usr/bin/env python3
"""
consume_product.py - Purchase and download digital products from x402 Omega Layer
...
Examples:
    ...
    python consume_product.py https://studio.x402omega.cc/pay/pussio
    python consume_product.py https://api.x402omega.cc/storage/product/abc123-uuid
...
# Constants
API_BASE = "https://api.x402omega.cc"
STUDIO_BASE = "https://studio.x402omega.cc"
...
def _print_usage() -> None:
    ...
    print("  python consume_product.py https://studio.x402omega.cc/pay/pussio")
...
def resolve_product_url(product_input: str) -> str:
    ...
    Accepts:
        - Product slug: "pussio"
        - Studio URL: "https://studio.x402omega.cc/pay/pussio"
        - API URL: "https://api.x402omega.cc/storage/product/{uuid}"
    """
    # Already an API URL
